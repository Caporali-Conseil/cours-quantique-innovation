...
Lorsqu'on applique ces concepts de signal aux particules quantiques (régies par l'équation de Schrödinger) :

1. **Particule libre vs confinée :** La solution d'onde pour une particule libre prend la forme d'un **paquet d'ondes gaussien** (et non d'une porte exacte). En revanche, pour une particule confinée dans un puits de potentiel rigide, le système impose des **ondes stationnaires**.
2. **Dispersion du milieu :** Contrairement aux ondes lumineuses dans le vide, le milieu est **dispersif** pour une particule matérielle. Cela signifie que la densité de probabilité (la gaussienne) va naturellement **s'étaler et s'aplatir au cours du temps** au fur et à mesure que la particule se déplace.
